...
yaw   = atan((u(2)-u(4))/(u(1)-u(3))); % (rad) vehicle's yaw orientations about global Z axis
 % (rad) front tire's steered angle (w.r.t. vehicle yaw angle)
...
%
   ...
   verts_tire_rf_XY = attitude*[verts_tire_rf_xy' + [Config.L/2;-Config.W/2]*ones(1,a_tire)] + [X;Y]*ones(1,a_tire);

   %verts_tire_lf_xy_steered = attitude_steered*[verts_tire_lf_xy'];
   verts_tire_lf_XY = attitude*[verts_tire_lf_xy' + [Config.L/2;+Config.W/2]*ones(1,a_tire)] + [X;Y]*ones(1,a_tire);
